...
public class GradesAverageCounterTest {
    ...
    public void countGradesAverage() {
        ...
        assertEquals(4.40, gradeAverageCounter.getStudentGradeAverage(student, course));
    }
    ...
    public void countGradesAverage_ifFewCoursesExists() {
        ...
        student.setGradeList(gradesTask);
        assertEquals(4.40, gradeAverageCounter.getStudentGradeAverage(student, course1));
    }
}